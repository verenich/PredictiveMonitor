...
public class OperationalSupport {
	...
	public static Map<String, Result> provideOperationalSupport(Vector<Formula> formulas, List<String> currentEvents, Vector<String> currentVariables, Map<String, String> variables, String traceID){
